...
export default function CreatePost() {
  ...
  return (
    <div className='p-3 max-w-3xl mx-auto min-h-screen'>
      <h1 className='text-center text-3xl my-7 font-semibold'>Add Book</h1>
      <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
        <div className='flex flex-col gap-4 sm:flex-row justify-between'>
          ...
          >
            <option value='uncategorized'>Genre</option>
          ...
          >
            <option value='uncategorized'>Select language</option>
        ...
        <div className='flex flex-col gap-4 sm:flex-row justify-between'>
          ...
          >
            <option value='uncategorized'>Rental Period</option>
